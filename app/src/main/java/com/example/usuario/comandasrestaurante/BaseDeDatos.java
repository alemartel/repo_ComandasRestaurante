...
public class BaseDeDatos extends SQLiteOpenHelper{
    ...
    String sqlLineaComand = "CREATE TABLE LineaComanda (idLinea INTEGER PRIMARY KEY AUTOINCREMENT, idComanda INTEGER NOT NULL, idProducto INTEGER NOT NULL, tipo INTEGER, cocineroFinalizacion TEXT DEFAULT NULL, comentario TEXT DEFAULT NULL, FOREIGN KEY(idComanda) REFERENCES Comandas(idComanda))";
